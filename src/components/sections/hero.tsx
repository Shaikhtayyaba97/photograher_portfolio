...
export function Hero() {
  ...
  return (
    <section className="w-full">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-center py-12 md:py-24 min-h-[85vh]">
        ...
        <div className="relative w-full h-80 md:h-[60vh] rounded-lg overflow-hidden shadow-2xl order-first md:order-last">
          <Image
            src="/hero.png"
