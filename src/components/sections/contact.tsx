...
export function Contact() {
  return (
    <section id="contact" className="py-16 md:py-24 glassmorphism m-4 rounded-lg">
      <div className="container grid lg:grid-cols-2 gap-12 md:gap-16 items-start">
        <div className="prose prose-lg text-muted-foreground max-w-none animate-fade-in-up text-center lg:text-left">
          ...
          <p>
           ...
           <div className="mt-8 space-y-4 not-prose">
             ...
             <div className="flex items-center gap-4 justify-center lg:justify-start text-center lg:text-left">
              <Pin className="w-5 h-5 text-accent flex-shrink-0" />
