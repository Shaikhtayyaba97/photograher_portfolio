...
const portfolioItems = [
  ...
  { category: "Weddings", src: "https://picsum.photos/800/600?random=2", hint: "wedding couple" },
  { category: "Weddings", src: "https://picsum.photos/800/600?random=6", hint: "wedding ceremony" },
